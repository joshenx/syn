        ...
        <Flex m="1rem" direction="column">
          <Box textAlign="left" width="min(80%, 720px)">
            ...
            <Text lineHeight="2rem" mt="1rem" align="left">
              Hi, I'm Joshen. I'm a musician of{' '}
              {new Date().getFullYear() - 2010} years, a graphic designer, and
              currently a Computer Science student at the National University of
              Singapore. I made this website to practise full-stack web
              development, and to simultaneously share my passion in music with
              others.
              <br></br>
              <br></br>
              This is my first ever web development project, so I appreciate
              your time to give feedback or even contribute to the source code.
              If you are here to interact with the gallery, have fun and really
              spend the time to reflect on what you hear in the music!
            </Text>
            <Heading
              fontWeight="normal"
              size="sm"
              ...
              lineHeight="2rem"
            >
              If you'd like to support me, I'd really appreciate if you decided
              to {}
              <Link
                fontWeight="medium"
