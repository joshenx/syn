		...
		>
			...
			>
				...
				<Text fontSize="md" fontStyle="normal">
					Whether you have an idea for a new feature, or you hate one of the
					songs in the gallery, or something's broken, or you wanna contribute,
					let me know!
				</Text>
				<Divider my="1rem" />
				<Textarea
				...
				{!showAlert && !showSuccess && (
					<Button fontWeight="normal" m="1rem 0rem" onClick={handleSubmit}>
						Submit
					</Button>
				)}
			</VStack>
