	...
	return (
        ...
        many people feel the same way as you!"
			...
			<Portal>
				<PopoverContent w={{ base: '80vw', md: '500px' }}>
					...
					<PopoverHeader alignSelf="center">
						<Heading size="md">NEW SYN</Heading>
					</PopoverHeader>
					<PopoverCloseButton />
					<PopoverBody>
						<Flex
            ...
            /> */}
							...
							>
								<VStack flexGrow="1" px="0rem" alignItems={{ base: 'left' }}>
									<Text>I hear...</Text>
									<Heading
										color={color}
									...
									<Text>at</Text>
									<Heading size="lg">{currTime}</Heading>
								</VStack>
								<VStack
									flexGrow="1"
							...
							<ScaleFade initialScale={0.9} in={showAlert}>
								<Alert borderRadius="10px" status="error" variant="solid">
									...
									<AlertDescription fontSize="sm">
										Submission failed. Either our server is down or your comment
										was naughty!
									</AlertDescription>
									<CloseButton
